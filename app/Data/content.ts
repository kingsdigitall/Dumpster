...
const blogContent: any = {
  posts: (() => {
    const defaultBlogPosts = [
      {
        title:
          "DEFAULT: How to Choose the Right Dumpster Size for Your Project",
        metaTitle:
          "DEFAULT: How to Choose the Right Dumpster Size for Your Project in [location]",
        metaDescription:
          "DEFAULT: Learn how to choose the perfect dumpster size for your home or construction project in [location]. Expert tips and sizing guide.",
        category: "DEFAULT: dumpster-sizing",
        categoryName: "DEFAULT: Dumpster Sizing",
        slug: "DEFAULT: choose-dumpster-size",
        h1: "DEFAULT: How to Choose the Right Dumpster Size for Your Project",
        description:
          "DEFAULT: Selecting the right dumpster size can save you time and money on your cleanup project.",
        postImageSrc:
          "https://ik.imagekit.io/h7rza8886p/Default1.jpg?updatedAt=1757319001930",
        postImageAlt: "DEFAULT: dumpster rental sizing guide",
        publishedAt: "DEFAULT: 2025-01-01",
        body: "DEFAULT: <p>Choosing the right dumpster size is crucial for any cleanup or construction project. This comprehensive guide will help you select the perfect size for your needs in [location].</p>",
      },
    ];
...
const blogCategoryMetaMap: any = (() => {
  const defaultCategoryMetas = {
    "DEFAULT: general": {
      title:
        "DEFAULT: Dumpster Rental Tips and Information | [location] Insights",
      description:
        "DEFAULT: Discover helpful tips and insights about dumpster rental services in [location]. Expert advice for your cleanup projects.",
      bannerImage:
        "https://ik.imagekit.io/h7rza8886p/Default1.jpg?updatedAt=1757319001930",
    },
  };
